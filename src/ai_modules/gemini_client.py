    ...
    async def generate_image(
        ...
        try:
            ...
            if response.generated_images:
                ...
                logger.info("✅ SUCCESS: Image generated by Imagen 3! (Not saving to disk/cloud yet)")
                return self._get_mock_image_response(prompt, model_name)
                
        except Exception as e:
            logger.warning(f"Imagen 3 Generation failed (likely allowlist restriction or 403): {e}")
