...
async def get_project_estimation(
    ...
    return {
        ...
        "flooring_cost": estimation.flooring_cost,
        "wall_cost": estimation.wall_cost,
        "ceiling_cost": estimation.ceiling_cost,
        "electrical_cost": estimation.electrical_cost,
        "plumbing_cost": estimation.plumbing_cost,
        "hvac_cost": estimation.hvac_cost,
        "furniture_cost": estimation.furniture_cost,
        "lighting_cost": estimation.lighting_cost,
        "decoration_cost": estimation.decoration_cost,
